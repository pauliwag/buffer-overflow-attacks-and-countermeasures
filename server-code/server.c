...
void main() {
    ...
    while (1) {
        ...
        if (pid == 0) {
            ...
            // Redirect STDIN to this connection, so it can take input from the user
            dup2(socket_fd, STDIN_FILENO);

            /* Uncomment the following to send the output back to the user (useful for remote attacks) 
            ...
            if (!connect(output_fd, (struct sockaddr *) &client, sizeof(struct sockaddr_in))) {
                ...
                // If the connection is made, redirect STDOUT to this connection
            ...
            */
            ...
            //execle(PROGRAM, PROGRAM, (char *) NULL, NULL); // Pass an empty environment variable array
	    
            /* Pass a randomly-generated environment variable array.
             * This slightly randomizes the stack's starting point. */
 ...
 * the stack location. This is used to add some randomness. */
